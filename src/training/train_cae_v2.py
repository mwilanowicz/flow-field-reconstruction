...
import torch
import os
from src.models.cae_v2 import CAE
...
SAVE_PATH = "checkpoints/cae_v2_best.pth"
os.makedirs("checkpoints", exist_ok=True)

HISTORY_PATH = "history/cae_v2_history.pth"
...
print(110 * "-")
print("CAE v2 Reconstruction Training:")
