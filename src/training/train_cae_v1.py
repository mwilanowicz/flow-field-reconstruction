...
import torch
import os
from src.models.cae_v1 import CAE
...
SAVE_PATH = "../checkpoints/cae_v1_best.pth"
os.makedirs("../checkpoints", exist_ok=True)

HISTORY_PATH = "../history/cae_v1_history.pth"
...
print(110 * "-")
print("CAE v1 Reconstruction Training:")
